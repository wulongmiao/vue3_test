      ...
      <el-aside class="aside">
        ...
        >
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              <el-menu-item index="/introduce" @click="clickTest">
              <i class="el-icon-data-line" />
              系统介绍:{{test}}，{{state.count.number}}
              </el-menu-item>
              <Test/>
              <div id='model'></div>
...
<script>
import { onUnmounted, reactive, ref, toRef, toRefs, readonly } from 'vue'
...
export default {
  ...
  setup() {
    ...
    return {
      // number:toRef(state.count,'number'),
      state,
      // ...toRefs(state),
      clickTest,
      test
