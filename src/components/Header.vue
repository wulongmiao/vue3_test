<template>
  <div class="header">
    <div class="left">
      ...
      <span style="font-size: 20px">{{ name}}，{{copyState.test}},{{copyState.name}},{{test}}</span>
    </div>
    <div class="right">
      <el-popover
        placement="bottom"
...
<script>
import { onMounted, reactive, toRefs, ref, toRef } from 'vue'
...
export default {
  ...
  setup(props,context) {
    ...
    copyState.test = 'changeState'
    const testRef = ref(11)
    onMounted(() => {
